...
no_parallel_coils = 3; 
current = 1; % peak of sine, current in each coil if they were all in series

%current = 6/.7071; % peak of sine, current in each coil if they were all in series
...
air_gap = 1+0.1; % per side distance from coil to magnet
...
%magnets
%magnet_thickness = 5.95; %UXA
magnet_thickness = 8.95; %UXX
magnet_height = 24.6;
% magnet_height = 15;

%back iron
%backiron_thickness = 8; %UXA
backiron_thickness = 10; %UXX
backiron_height = 456/2; % 36.35
% backiron_height = 105;
...
start_magnet_y = 10.18/2 % over-ride
start_magnet_y = 10.2/2 % over-ride
...
%% draw back irons
mi_drawrectangle(backiron_height-magnetic_pitch*2,start_backiron_y,-backiron_height-magnetic_pitch*2,end_backiron_y);
